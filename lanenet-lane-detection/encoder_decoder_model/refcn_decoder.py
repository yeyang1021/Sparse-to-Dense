...
class FCNDecoder(cnn_basenet.CNNBaseModel):
    ...
    def decode(self, input_tensor_dict, decode_layer_list, name):
        ...
        with tf.variable_scope(name):
            ...
            before_score_final = self.conv2d(inputdata=score, out_channel=16,
                                      kernel_size=1, use_bias=False, name='before_score_final')
            before_score_final1 = self.conv2d(inputdata=before_score_final, out_channel=16,
                                      kernel_size=1, use_bias=False, name='before_score_final1')
            before_score_final2 = self.conv2d(inputdata=before_score_final1, out_channel=1,
                                      kernel_size=1, use_bias=False, name='before_score_final2')                                      
            ...
            ret['map'] = score_final
            ret['refine'] = before_score_final2
