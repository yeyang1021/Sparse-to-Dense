...
from lanenet_model import mylanenet2_merge_model
from data_provider import my_data_processor
...
def train_net(dataset_dir, weights_path=None, net_flag='vgg'):
    ...
    train_dataset = my_data_processor.DataSet(train_dataset_file)
    val_dataset = my_data_processor.DataSet(val_dataset_file)
    ...
    net = mylanenet2_merge_model.LaneNet(net_flag=net_flag, phase=phase)
