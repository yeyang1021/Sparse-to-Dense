...
def train_net(dataset_dir, weights_path=None, net_flag='vgg'):
    ...
    compute_ret = net.compute_loss(input_tensor1=input_tensor1, input_tensor2=input_tensor2,
                                   gt_label=gt_label, mask_label=mask_label, cam_label= cam_label, xx_label= xx_label, yy_label = yy_label, name='dense_loss')
    ...
    with sess.as_default():
        ...
        for epoch in range(train_epochs):
            ...
            _, c, d_loss, x_l, y_l, train_summary,   = \
                sess.run([optimizer, total_loss, dense_loss, x_loss, y_loss,
            ...
            c_val, d_loss_val, x_l_val, y_l_val, val_summary = \
                sess.run([total_loss, dense_loss, x_loss, y_loss, val_merge_summary_op],
